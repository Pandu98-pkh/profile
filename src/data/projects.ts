...
export const projects = [
  ...
  },
  {
    ...
    description: 'Proyek akhir Bootcamp Basic SCHEMATICS 2024 ITS ini merupakan pengembangan Form Registrasi Rumah Sakit menggunakan HTML, CSS, dan JavaScript. Proyek ini mencakup pembuatan formulir interaktif untuk input data pasien, validasi form, dan desain antarmuka yang responsif. Proyek ini diselesaikan pada tahun 2024 sebagai bukti pemahaman dasar saya dalam pengembangan front-end web.',
